...
Appelez chacune de ces 2 fonctions (maintenant modifiées) et affichez les résultats pour la racine carrée, cubique et
quatrième de 8, 9, 81 et 123. \
Par exemple, vous pouvez ajouter ce code à la fin de votre script `validation.py` pour tester les fonctions maintenant généralisées :
