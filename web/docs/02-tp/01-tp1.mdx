...
```python
print("*** VÉRIFICATION DU BON FONCTIONNEMENT DE LA MÉTHODE [nom_de_la_fonction] LORS DU CALCUL D'UN RACINE-N ***\n")
...
print("*** VÉRIFICATION DES PARAMÈTRES DE LA MÉTHODE [nom_de_la_fonction] LORS DU CALCUL D'UN RACINE-N ***")
try:
