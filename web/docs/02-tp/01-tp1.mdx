...
```
[Téléchargez `autocorrection.py`](/ressources/tp1/autocorrection.py) et placez-le dans votre projet.
:::
...
[//]: # (            \text{milieu}^2 < n: & \text{on déplace bas = milieu},\\)

[//]: # (            \text{milieu}^2 \ge n: & \text{on déplace haut = milieu}.)
...
[//]: # ()
    [//]: # (    On répète l'opération de réduction de l'intervalle jusqu'à ce que la largeur de l’intervalle &#40;$\text{haut} - \text{bas}$&#41; soit inférieure à la précision souhaitée.)

[//]: # (    À ce moment, la racine est approximée par $\frac{\text{bas} + \text{haut}}{2}$.)

[//]: # ()
    [//]: # (    **Exemple &#40;racine de $8$, avec $3$ décimales de précision&#41;**<br />)
