...
<Tabs queryString="onglet">
    ...
    <TabItem value="retour" label="Retour">
        ...
        La valeur retournée doit ensuite être stockée dans une variable si on souhaite la réutiliser plus tard, ici la variable `resultat` à l'aide de l'opérateur d'assignation `=`.
        ...
        :::warning
        Vous ne devez jamais tentez de faire un print d'un appel d'une fonction retournant rien.
        :::
