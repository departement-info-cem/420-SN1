...
<Tabs queryString="onglet">
    ...
    <TabItem value="Principe DRY" label="Principe DRY">
        ...
        print("Sur l'astre Terre, le poids est de", poids_terre, "Newtons.")

        # Calcul et affichage pour Mars
        poids_mars = masse_spationaute * 3.71
        print("Sur l'astre Mars, le poids est de", poids_mars, "Newtons.")

        # Calcul et affichage pour la Lune
        poids_lune = masse_spationaute * 1.62
        print("Sur l'astre Lune, le poids est de", poids_lune, "Newtons.")
        ```
        ...
        print("Sur l'astre Terre, le poids est de", p_terre, "Newtons.")

        p_mars = calculer_poids(masse_spationaute, 3.71)
        print("Sur l'astre Mars, le poids est de", p_mars, "Newtons.")

        p_lune = calculer_poids(masse_spationaute, 1.62)
        print("Sur l'astre Lune, le poids est de", p_lune, "Newtons.")
        ```
        ...
        def afficher_poids_astre(nom_astre, m, g):
            ...
            print("Sur l'astre", nom_astre, ", le poids est de", poids_calcule, "Newtons.")
        ```
        ::::
