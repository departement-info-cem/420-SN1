    ...
    <TabItem value="Activités" label="Activités">
        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                Écrivez une fonction `aire_rectangle(cote1, cote2)` qui calcule et **retourne** l’aire d’un rectangle.<br />
                ...
                1) Écrivez une fonction `aire_rectangle(cote1, cote2)` qui calcule et **retourne** l’aire d’un rectangle.
