    ...
    <TabItem value="Activités" label="Activités">
        ...
        <Tabs>
            <TabItem value="1" label="🏠 Activités à faire à la maison">
                ...
                # 🎯 Solutionnaires des exercices de compréhension
                ...
                - Appel de fonction — [solutionnaire.pdf](/pdf/r03_appel_de_fonction_solutionnaire.pdf)
                - Appel de fonction avec paramètres — [solutionnaire.pdf](/pdf/r03_appel_de_fonction_parametres_solutionnaire.pdf)
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                **Instructions pour vous aider dans votre réflexion**
                ...
                :::note Notions visées
                Appel de fonction, valeur de retour, trace d'exécution, débogueur (points d'arrêt, exécution pas à pas)
                :::
                ...
                **vous débloquer après un long** moment bloqué sur un exercice (**ex. 20 minutes**) et après avoir utilisé le dégogueur pour essayer par vous-même de trouver le problème.
                ...
                - Points d'arrêt *(solutionnaire à venir)*
