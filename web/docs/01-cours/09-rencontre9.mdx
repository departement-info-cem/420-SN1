    ...
    <TabItem value="Activités" label="Activités">
        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                - Stockez tous les essais de l'utilisateur dans une liste.
                ...
                **vous débloquer après un long** moment bloqué sur un exercice (**ex. 20 minutes**) et après avoir utilisé le dégogueur pour essayer par vous-même de trouver le problème.
                ...
                - [Affichage des virus - liste simple](https://youtu.be/wIhuAruO89k)
                - [Affichage des virus - listes parallèles](https://youtu.be/ORzaM_ShgqE)
                - [Affichage des virus - liste à 2 dimensions](https://youtu.be/BsvzXxJ6cRI)
                - [Manipulation de listes par compréhension](https://youtu.be/_4zswSbg81A)
                - [Manipulation d'ensemble](https://youtu.be/mNRrxtP3PiQ)
                - [Jeu de devinette amélioré](https://youtu.be/Dia3pez6Ur0)
                - [Graphique - Courbe simple](https://youtu.be/ba8MpXdisGs)
                - Graphique - Températures annuelles *(solutionnaire à venir)*
                - [Graphique - Barres et moyennes](https://youtu.be/mMsrtCnTqAI)
                - Graphique - Populations par saison *(solutionnaire à venir)*
                - [Graphique - Nuage de points et courbe](https://youtu.be/THG-02AgDQ4)
                - Dictionnaires #2 *(solutionnaire à venir)*
           </TabItem>
        </Tabs>
