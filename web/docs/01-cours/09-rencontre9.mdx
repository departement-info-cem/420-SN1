...
<Tabs queryString="onglet">
    ...
    <TabItem value="foreach" label="For (séquence)" default>
        ...
        <Feedback surveyId="Rencontre #9 - For (séquence)" />
    </TabItem>
    ...
    <TabItem value="listcomp" label="Compréhension de liste">
        ...
        <Feedback surveyId="Rencontre #9 - Compréhension de liste" />
    </TabItem>
    ...
    <TabItem value="set" label="Ensemble (set)">
        ...
        **`KeyError`** Se produit lorsqu'on tente de **supprimer** un élément absent avec `remove()` :
        ...
        <Feedback surveyId="Rencontre #9 - Ensemble (set)" />
    </TabItem>
    ...
    <TabItem value="tuple" label="Tuple (tuple)">
        ...
        **`IndexError`** Se produit lorsqu'on tente d'accéder à un **index inexistant** :
        ...
        <Feedback surveyId="Rencontre #9 - Tuple (tuple)" />
    </TabItem>
    ...
    <TabItem value="dict" label="Dictionnaire (dict)">
        ...
        **`KeyError`** Levée dans deux situations : quand on **accède** à une clé inexistante ou quand on tente de la **supprimer** :
        ...
        <Feedback surveyId="Rencontre #9 - Dictionnaire (dict)" />
    </TabItem>
    ...
    <TabItem value="matplotlib" label="Matplotlib">
        ...
        <Feedback surveyId="Rencontre #9 - Matplotlib" />
    </TabItem>
