...
<Tabs queryString="onglet">
    ...
    <TabItem value="matplotlib" label="Matplotlib">
        ...
        Pour rendre le graphique plus compréhensible, on peut ajouter un titre au graphique et des étiquettes (*labels*) aux axes :
        <Row>
            <Column>
                ```python showLineNumbers
                import matplotlib.pyplot as plt
        ...
        <Row>
            <Column>
                ...
                plt.legend()  # Affiche la légende
                              # avec les étiquettes définies
                              # dans les appels à plt.plot()
