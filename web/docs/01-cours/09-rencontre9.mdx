        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                while True:
                    ...
                    if devine == nombre_secret: #Condition d'arrêt de la boucle
                        break
                    elif devine < nombre_secret: # Indication sur la direction, même si l'essai était répété
                        print("Plus haut!\n")
                    else:
                        print("Plus bas!\n")
                ...
                **Étape 3 - Calculer et tracer la moyenne**
                ...
                :::tip Indices
                - La transparence des points peut être déterminée avec le paramètre `alpha` (ex : `alpha=0.50`).
                ...
                ```python showLineNumbers
               jours = list(range(1, 31)) #Génère une liste [1,2,3,...,28,29,30]
                ...
                **N'exécutez pas le code avant d'avoir terminé vos réponses !**
                ...
                - [Affichage des virus - liste simple](https://youtu.be/RikS6EnFKpw)
                - [Affichage des virus - listes parallèles](https://youtu.be/Q4orZ_PkyFw)
                - [Affichage des virus - liste à 2 dimensions](https://youtu.be/WepoPsHV6h8)
                - [Manipulation de listes par compréhension](https://youtu.be/1uzdH_gf67c)
                - [Manipulation d'ensembles](https://youtu.be/jstmXBGThvc)
                - [Dictionnaires - Dictionnaire imbriqué](https://youtu.be/PhXHA-D7-Z4)
                - [Jeu de devinette amélioré](https://youtu.be/KirCyRxAQQ8)
                - [Graphique - Courbe simple](https://youtu.be/6GZYgnNQArg)
                - [Graphique - Températures annuelles](https://youtu.be/h9LieDJAsn4)
                - [Graphique - Barres et moyennes](https://youtu.be/PMeDAaXGkF8)
                - [Graphique - Populations par saison](https://youtu.be/3q-lx0odPUY)
                - [Graphique - Nuage de points et courbe](https://youtu.be/7HOZ1fuFrws)
           </TabItem>
        </Tabs>
