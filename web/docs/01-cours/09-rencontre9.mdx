        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                **N'exécutez pas le code avant d'avoir terminé votre dessin !**
                ...
                📁 Créez un fichier `r09_virus.py` pour votre réponse.
                ...
                📁 Créez un fichier `r09_virus_v1.py` pour votre réponse.
                ...
                📁 Créez un fichier `r09_virus_v2.py` pour votre réponse.
                ...
                *Indices :*
                ...
                📁 Créez un fichier `r09_statistiques_v1.py` pour votre réponse.
                ...
                *Conservez uniquement les 2 premières décimales*
                ...
                📁 Créez un fichier `r09_statistiques_v2.py` pour votre réponse.
                ...
                📁 Créez un fichier `r09_graphique_1.py` pour votre réponse.
                ...
                📁 Créez un fichier `r09_graphique_2.py` pour votre réponse.
               ...
               plante10 = [0.0, 1.6617879828120876, 1.1114070518778814, 1.2413536244030396, 1.0957815500862658, 1.5336617782080486, 1.6312859846759336, 4.19868256424098, 3.416719289385172, 4.608614661530128, 3.5593769395445642, 6.521317626985673, 5.077549860821263, 9.603200324467075, 5.755340324739416, 9.639255450256496, 14.271414716495176, 12.778076460254391, 15.402533086111394, 16.708734436876853, 14.17417569230928, 17.100934078054095, 18.80519666846201, 14.897059850615431, 21.046899131076906, 15.375114293061099, 16.463903627318345, 20.611482792264987, 19.857870964605823, 19.38782379439097]
                ...
                📁 Créez un fichier `r09_graphique_3.py` pour votre réponse.
                ...
                📁 Créez un fichier `r10_graphique4.py` pour votre réponse.
                ...
                📁 Créez un fichier `r10_dictionnaires_1.py` pour votre réponse.
                ...
                **INDICES**
                ...
                📁 Créez un fichier `r10_dictionnaires_2.py` pour votre réponse.
                ...
                ```
                Il est possible d'obtenir un alignement similaire en utilisant les options de [formatage des chaînes de caractères](/cours/rencontre2?onglet=fonctions) des f-string
