...
<Tabs queryString="onglet">
    ...
    <TabItem value="ia" label="*🤖 Intelligence artificielle*" default>
        ...
        <Feedback surveyId="Rencontre #12 - 🤖 Intelligence artificielle" />
    </TabItem>
    ...
    <TabItem value="ml" label="*🧠🧮 Apprentissage machine*">
        ...
        <Feedback surveyId="Rencontre #12 - 🧠🧮 Apprentissage machine" />
    </TabItem>
    ...
    <TabItem value="dl" label="*🧠🕸️ Apprentissage profond*">
        ...
        <Feedback surveyId="Rencontre #12 - 🧠🕸️ Apprentissage profond" />
    </TabItem>
    ...
    <TabItem value="ecologisation" label="*🌳 Empreinte écologique*">
        ...
        <Feedback surveyId="Rencontre #12 - 🌳 Empreinte écologique" />
    </TabItem>
    ...
    <TabItem value="learn" label="*🤖 Scikit-learn*">
        ...
        <Feedback surveyId="Rencontre #12 - 🤖 Scikit-learn" />
    </TabItem>
