...
<Tabs queryString="onglet">
    ...
    <TabItem value="pandasfiltrer" label="Filtrer / Trier">
        ...
        ```python
        # Filtrer pour conserver que les lignes où le pourboire est supérieur à 5
        df_filtre1 = df[df["tip"] > 5]
        print(df_filtre1)

        # Filtrer pour conserver que les lignes où le jour est "Sun" et le temps "Dinner"
        df_filtre2 = df[(df["day"] == "Sun") & (df["time"] == "Dinner")]
        print(df_filtre2)

        # Filtrer pour conserver que les lignes où le jour contient la chaîne de caractère "u" (ceci limite les résultats aux jours : Sun et Thur)
        df_filtre3 = df[df["day"].str.contains("u")]
        print(df_filtre3)

        # Filtrer pour conserver que les lignes où le serveur est une femme et le pourboire supérieur à 3
        df_filtre4 = df[(df["sex"] == "Female") & (df["tip"] > 3)]
        print(df_filtre4)

        # Filtrer pour conserver que les lignes où la longueur de la chaîne dans la colonne "day" est supérieure à 3
        df_filtre5 = df[df["day"].str.len() > 3]
        print(df_filtre5)

        # Filtrer pour conserver que les lignes où le jour est dans une liste de valeur souhaitée
        ...
        :::info 📈 Trier et ordonner les données
