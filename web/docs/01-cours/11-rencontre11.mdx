...
<Tabs queryString="onglet">
    ...
    <TabItem value="pandasparcourir" label="Parcourir">
        ...
        df_consoles = pd.DataFrame({
            "Console": ["PlayStation 5", "Xbox Series X|S", "Nintendo Switch 2"],
        ...
        **Exemple avec plusieurs colonnes :**
        ...
        Xbox Series X|S (2020) : 35.0M unités vendues
        ...
        print(liste_consoles) # → [‘PlayStation 5’, ‘Xbox Series X|S’, ‘Nintendo Switch 2’]
        ```
    ...
    <TabItem value="pandasvisualiser" label="Visualiser">
        ...
        | Élément | Description |
        |---|---|
        | **Ligne du milieu (orange)** | La **médiane** : 50 % des valeurs sont en dessous, 50 % au-dessus |
        | **Bas de la boîte** | Le **1er quartile (Q1)** : 25 % des valeurs sont en dessous |
        | **Haut de la boîte** | Le **3e quartile (Q3)** : 75 % des valeurs sont en dessous |
        | **Hauteur de la boîte** | L'**intervalle interquartile (IQR)** = Q3 − Q1 : contient le 50 % central des données |
        | **Moustaches (les traits)** | S'étendent jusqu'à 1,5 × IQR au-delà de Q1 et Q3 |
        | **Cercles (•)** | Les **valeurs aberrantes** (*outliers*) : valeurs qui dépassent les moustaches |
