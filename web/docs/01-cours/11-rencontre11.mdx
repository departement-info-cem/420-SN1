        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                **Visualisation**
                ...
                - [Analyse : Modèles de véhicules](https://youtu.be/ACjlksN-xKw)
                - [Analyse : Prix Turing](https://youtu.be/yahywyUm1Js)
                - [groupby et moyenne](https://youtu.be/ojGejHpxzzI)
                - [Nettoyage et sélection de données](https://youtu.be/30E8zQ24Y0o)
                - [Visualisation : Pourboire par personne](https://youtu.be/ASPe9BFQVr0)

                ✏️ Solution des **exercices sur papier** :
                - [Écrire du code sans PyCharm](https://youtu.be/gQePmX6e-Nk)
            </TabItem>
        </Tabs>
    </TabItem>
