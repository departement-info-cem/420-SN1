...
<Tabs className="tabs-centered-left" queryString="onglet">
    ...
    <TabItem value="pandas" label="Pandas DataFrame">
        ...
        <Feedback feedbackId="Rencontre #11 - Pandas DataFrame" />
    </TabItem>
    ...
    <TabItem value="pandasselectionner" label="Sélectionner Series Parcourir">
        ...
        <Feedback feedbackId="Rencontre #11 - Sélectionner Series Parcourir" />
    </TabItem>
...
<TabItem value="pandastransformer" label="Transformer">
    ...
    :::
        ...
        <Feedback feedbackId="Rencontre #11 - Statisques Agréger Pivot" />
    </TabItem>
