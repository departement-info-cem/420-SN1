...
<Tabs queryString="onglet">
    ...
    <TabItem value="pandasselectionner" label="Sélectionner/Parcourir">
        ...
        :::info 🔁 Parcourir ligne par ligne un DataFrame
        ...
        :::info 🔍 Récupérer le contenu d'une ligne et d'une colonne en particulier
...
<TabItem value="pandastransformer" label="Transformer">
    ...
    <TabItem value="pandasgrouper" label="Grouper/stats">
    :::info 🧠 Statistiques et agrégations
