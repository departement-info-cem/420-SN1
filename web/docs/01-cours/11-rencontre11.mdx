...
<Tabs queryString="onglet">
    ...
    <TabItem value="pandas" label="🐼 Pandas">
        ...
        Une fois vos données chargées dans un *DataFrame*, vous pouvez effectuer une grande variété d’opérations. \
        ...
        # Affiche les noms des colonnes uniquements sous forme d'une liste de string
