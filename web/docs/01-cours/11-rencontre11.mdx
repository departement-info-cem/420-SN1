...
<TabItem value="pandastransformer" label="Transformer">
    ...
    <TabItem value="learn" label="🤖 Scikit-learn">
        ...
        :::danger 🚧 Contenu en cours de mise à jour
        Le contenu de cet onglet sera prochainement mis à jour ; \
        vous pouvez toutefois le consulter dès maintenant pour débuter les exercices par anticipation. \
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        :::danger 🚧 Formulaire bientôt disponible
        Le formulaire d'autoévaluation n'est pas encore disponible. Merci de votre patience !
        :::

        [**Ce formulaire**](https://google.com) sert à vérifier votre compréhension des éléments les plus importants de la rencontre R11. Ne faites ce questionnaire **que lorsque vous vous sentez en très bonne maîtrise de la matière**. En classe, dès votre arrivée, vous aurez un **questionnaire très similaire**, évalué **sommativement**, à compléter sans accès à **aucune documentation**.
