...
Voici comment Python évalue l’instruction #5, étape par étape :
    ...
    <TabItem value="DRY" label="DRY">
        ...
        :::info Éviter la répétition : dans vos structures conditionnelles
        ...
        if pression_atm > 2.0 :
            ...
            print("✅ Pression dans les normes.")
        print("=== Fin du rapport ===")                 # ✅ Redondance déplacée avant les blocs
        ```
        ...
        ```
        Ici, les deux `print` contiennent du texte différent. Ils doivent rester dans leur bloc respective.
        :::
