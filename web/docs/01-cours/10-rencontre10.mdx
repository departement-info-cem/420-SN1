...
<Tabs className="tabs-centered" queryString="onglet">
    ...
    <TabItem value="csv" label="Fichier CSV">
        ...
        with open("mesures.csv", "r", encoding="utf-8") as fichier:
            for ligne in fichier: #Boucles sur toutes les lignes du fichier
        ...
        Pandas est généralement l'outil le plus pratique pour travailler avec des fichiers CSV réels. Plus tard dans le cours, nous verrons en détail la bibliothèque Pandas.
        ...
        |---|---|---|---|
        | Lecture manuelle | ✅ Aucune | Permet de comprendre la structure du fichier | Il faut tout gérer soi-même |
        | Module `csv` | ✅ Aucune | Inclus avec Python et adapté aux fichiers CSV simples | Les valeurs restent principalement du texte |
        | NumPy | 📦 `pip install numpy` | Très utile pour les données numériques | Moins pratique pour les tableaux avec des types variés |
