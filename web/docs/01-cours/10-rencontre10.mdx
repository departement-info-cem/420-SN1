...
<Tabs className="tabs-centered" queryString="onglet">
    ...
    <TabItem value="fichier" label="Fichier (intro)">
        ...
        <Feedback surveyId="Rencontre #10 - Fichier" />
    </TabItem>
    ...
    <TabItem value="texte" label="Fichier texte">
        ...
        <Feedback surveyId="Rencontre #10 - Fichier texte" />
    </TabItem>
    ...
    <TabItem value="csv" label="Fichier CSV">
        ...
        <Feedback surveyId="Rencontre #10 - Fichier CSV" />
    </TabItem>
    ...
    <TabItem value="json" label="Fichier JSON">
        ...
        <Feedback surveyId="Rencontre #10 - Fichier JSON" />
    </TabItem>
    ...
    <TabItem value="numpy" label="NumPy (intro)">
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Intro" />
    </TabItem>
    ...
    <TabItem value="numpy-tableaux" label="Tableaux NumPy">
        ...
        **`dtype`** - le type des données stockées :
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Tableaux" />
    </TabItem>
    ...
    <TabItem value="numpy-vectorise" label="Calcul vectorisé">
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Vectorisé" />
    </TabItem>
    ...
    <TabItem value="numpy-bornes" label="Bornes et correction">
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Bornes" />
    </TabItem>
    ...
    <TabItem value="numpy-conditions" label="Filtres et masques">
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Conditions" />
    </TabItem>
    ...
    <TabItem value="restructurer-sauvegarder" label="Restructurer sauvegarder">
        ...
        **`np.random.randint()`** génère des nombres entiers aléatoires dans un intervalle `[min, max[` :
        ...
        <Feedback surveyId="Rencontre #10 - NumPy Manipulation" />
    </TabItem>
    ...
    <TabItem value="matplotlib" label="NumPy et Matplotlib">
        ...
        <Feedback surveyId="Rencontre #10 - NumPy et Matplotlib" />
    </TabItem>
