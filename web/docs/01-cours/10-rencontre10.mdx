...
<Tabs queryString="onglet">
    ...
    <TabItem value="fichier" label="Fichier">
        ...
        - L'encodage (très important) : Pour les fichiers texte, il faut définir un encodage de caractères (le standard étant l'UTF-8).
            - C'est la « table de traduction » qui permet à l'ordinateur de transformer les bits (0 et 1) en lettres et en accents.
