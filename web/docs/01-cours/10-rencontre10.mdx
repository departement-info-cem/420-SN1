...
<Tabs queryString="onglet">
    ...
    <TabItem value="exercices" label="Exercices">
        ...
        **Résultats attendus** \
        ...
        - lettre = "a" ➡️ votre programme doit afficher : 4
        - lettre = "b" ➡️ votre programme doit afficher : 7
        - lettre = "c" ➡️ votre programme doit afficher : 4
        - lettre = "d" ➡️ votre programme doit afficher : 0

        **Contraintes**
        - **Vous n'avez pas le droit à Pycharm** : vous devez écrire le code sur papier (comme ça sera le cas à l'[examen final](/cours/rencontre15)).
