        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                **Une fois votre graphique tracé sur papier**, validez votre réponse à l'aide de Pycharm.
                ...
                - [Créer et inspecter des tableaux](https://youtu.be/da9aAJ2ZDBg)
                - [NumPy vs boucles](https://youtu.be/1NrT-Vhbyxo)
                - [Oscillation amortie](https://youtu.be/JuuDB6SsJmE)
                - [Notes d'étudiants](https://youtu.be/ZTNXxpHi2XQ)
                - [Traitement des pixels](https://youtu.be/lTY3GSsoS5o)
                - [Manipulation et aléatoire](https://youtu.be/sMtGszzDnKU)
                - [Fichier JSON](https://youtu.be/ZL2nV_RlE50)
                - [Fichiers texte](https://youtu.be/Jc071AG2s_w)

                ✏️ Solution des **exercices sur papier** :
                - [Écrire du code sans PyCharm #1](https://youtu.be/cLJVmXZ62qA)
                - [Écrire du code sans Pycharm #2](https://youtu.be/n2Bt5-nPpHs)
            </TabItem>
        </Tabs>
